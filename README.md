...
This work provides **the first evidence** that a generalist reconstruction foundation model can be successfully applied to and fundamentally reshape accelerated CMR paradigms, **revealing substantial untapped acceleration potential and strong heterogeneous generalization**. 
